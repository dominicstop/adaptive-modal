...
class RNIAnimator {
  ...
  private(set) var timeStart: CFTimeInterval = 0;
  private(set) var timeEnd: CFTimeInterval = 0;
  
  private(set) var timeCurrent: CFTimeInterval = 0;
  private(set) var timeElapsed: CFTimeInterval = 0;
  
  private(set) var progress: CGFloat = 0;
  private(set) var duration: CFTimeInterval;
  
  let animatedValuesSize: Int;
  
  private(set) var animatedValuesStart: [CGFloat];
  private(set) var animatedValuesEnd: [CGFloat];
  
  private(set) var animatedValuesPrev: [CGFloat] = [];
  private(set) var animatedValuesCurrent: [CGFloat] = [];
  
  var allowAnimatedValueToRegress = true;
  ...
  var onAnimatedValueChange: ((_ animatedValues: [CGFloat]) -> Void)?;
